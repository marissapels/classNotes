...
insert into favorite_songs (song, artist, genre)
values ("I want it that way","Backstreet Boys", "pop");
insert into favorite_songs (song, artist, genre)
values ("Bye Bye Bye","NSync", "pop");
insert into favorite_songs (song, artist, genre)
values ("Stronger","Britney Spears", "pop");
