...
var Imgr = React.createClass({
  ...
  componentWillReceiveProps: function() {
    ...
    //this.setState cannot be done inside the render function because when you change the state, it will re-render. This will cause to put it in an infinite loop.
